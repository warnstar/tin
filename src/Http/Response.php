...
class Response extends Message implements ResponseInterface
{
     ...
     * code to 302 to mimic what PHP does. See https://github.com/Tinphp/Tin/issues/1730
     *
    ...
    public function withHeader($name, $value)
    {
        ...
        if ($this->getStatusCode() === StatusCode::HTTP_OK && strtolower($name) === 'location') {
            $this->withStatus(StatusCode::HTTP_FOUND);
        }
    ...
    /**
     * Write data to the swoole response.
     *
    ...
    public function end($html = '')
    {
        ...
        if ($headers) {
            foreach ($headers as $k => $v) {
                $this->swResponse->header($k, implode(';', $v));
            }
        }
