...
class Uri implements UriInterface
{
     ...
     * @return self
     */
    public static function createFromSwoole(\Swoole\Http\Request $swooleRequest)
    {
        $scheme = 'http';
        $user = '';
        $pass = '';
        $host = isset($swooleRequest->header['host']) ? $swooleRequest->header['host'] : '';
        $port = isset($swooleRequest->server['server_port']) ? $swooleRequest->server['server_port'] : null;
        $path = isset($swooleRequest->server['path_info']) ? $swooleRequest->server['path_info'] : '';
